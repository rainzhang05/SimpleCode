...
struct ColorRoleTests {
    ...
    @Test func semanticAppearanceDefaultsUseNeutralCanvasInkAndSystemBlueCues() throws {
        ...
        #expect(ColorRoleDefaults.gutterBackground.light == ColorRoleDefaults.editorBackground.light)
        #expect(ColorRoleDefaults.gutterBackground.dark == ColorRoleDefaults.editorBackground.dark)
